...
The following defines the core set of genes of interest.
More is added below from the "Daneman clusters".
...
```{r, warning=FALSE, out.extra='class="scrollable"',  results='hide'}
...
```{r, dpi=72, out.extra='class="scrollable"', results='hide', out.width='20%', eval=FALSE, include=FALSE}
show_heatmap_slides(
...
```{r, dpi=72, out.extra='class="scrollable"', results='hide'}
show_heatmap_slides(
...
Click on the plot to scroll through the clusters
(shift-click to cycle back).

```{r, cache=TRUE, message=FALSE, warning=FALSE, results='hide', eval=TRUE, out.extra='class="zoomable scrollable"'}
(0:7) %>%
  lapply(function(i) {
    datasets$grouped %>%
